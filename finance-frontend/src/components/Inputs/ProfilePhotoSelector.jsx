    ...
    <div className="flex justify-center mb-6">
      ...
      {!image ? (
        <div className="w-20 h-20 flex items-center justify-center bg-gray-100 rounded-full relative">
          <LuUser className="text-4xl text-primarycolor" />
        ...
        <div className="relative">
          ...
          <button className="w-8 h-8 flex items-center justify-center bg-red-500 rounded-full text-white absolute -bottom-1 -right-1" type="button" onClick={handleRemoveImage}>
            <LuTrash />
          </button>
        </div>
      )}
